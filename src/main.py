...
#Your URL here Above URL is for reference only. You can use any product URL from Amazon.in
target = "ASUS Gaming V16" #Your Target Product Name Here
target_price = 90000.0  #Your target price
...
if __name__ == "__main__":
    ...
    if target_price >= price:
        ...
        print(f"The price of {target} is above the target price. Consider waiting for a price drop. \nAmazon Link : http://www.amazon.in/")